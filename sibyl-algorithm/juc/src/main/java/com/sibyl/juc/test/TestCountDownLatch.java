package com.sibyl.juc.test;

import com.sibyl.juc.Sleeper;
...
import static com.sibyl.juc.Sleeper.sleep;
...
public class TestCountDownLatch {
    ...
    private static void test3() throws InterruptedException, ExecutionException {
        ...
        CountDownLatch latch = new CountDownLatch(4);//适合无返回结果，有返回结果还是Future
